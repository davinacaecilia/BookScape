...
@include('produk.navbar2')
  ...
  <main class="rating-main-content">
    <div class="rating-card">
      <div class="book-info">
        <img src="https://ebooks.gramedia.com/ebook-covers/34734/big_covers/ID_KPG2016MTH10DDAG_B.jpg" alt="Sampul Buku" class="book-cover">
      ...
      <div class="rating-stars">
        ...
        <div class="stars">
            <input type="radio" id="star5" name="rating" value="5"><label for="star5" title="5 bintang"><i class="fas fa-star"></i></label>
      ...
      <button class="submit-review-btn" id="submitReviewBtn" disabled>Kirim</button>
    </div>
  </main>
