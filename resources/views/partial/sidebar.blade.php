<section id="sidebar">
    ...
    <ul class="side-menu top">
        ...
        {{-- BAGIAN INI YANG DIKOREKSI --}}
        <li class="{{ Request::routeIs('admin.ratings') ? 'active' : '' }}"> {{-- Gunakan Request::routeIs() --}}
            <a href="{{ route('admin.ratings') }}"> {{-- Gunakan helper route() --}}
        ...
        <li>
            <a href="{{ url('logout') }}" class="logout" onclick="return confirm('Are You Sure Want to Log Out?');">
